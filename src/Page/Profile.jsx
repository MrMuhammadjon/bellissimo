...
const Profile = () => {
    ...
    return (
        <div className="w-full fixed top-0 min-h-screen bg-gray-50 pt-6 px-4">
            {/* Mobile Menu */}
            <MobileMenu isOpen={menuOpen} onClose={() => setMenuOpen(false)} />
            <HomeBtn />

            {/* Profile Card */}
            <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl p-6 relative">
                ...
                <div className="mt-6 border-t pt-4">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 text-red-600 hover:text-red-700 text-sm font-semibold px-4 py-3 bg-red-50 hover:bg-red-100 rounded-lg border border-red-200 transition"
                    >
