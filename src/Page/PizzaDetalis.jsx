...
<div
  id="productDetalis"
  className="fixed inset-0 z-50 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center p-4 sm:p-10"
>
  <motion.div
    ...
    className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 sm:p-10"
  >
    {/* Orqaga tugma */}
    <button
      onClick={() => navigate(-1)}
    ...
    >
      <img
        src={product.img}
        alt={product.name}
        className="rounded-xl w-full h-[250px] sm:h-[350px] md:h-[400px] object-cover"
      />
