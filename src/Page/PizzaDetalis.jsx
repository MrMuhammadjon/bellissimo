...
//       .then(res => {
//         const found = res.data.find(p => p.category === category);
...
//       return (
//       <div className="fixed inset-0 z-50 bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-10">
//         <motion.div
