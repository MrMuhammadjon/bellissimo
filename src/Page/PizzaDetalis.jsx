        ...
        >
          <div>
            ...
            <div className="text-gray-600 text-sm mb-1 flex items-center gap-2 ">
              Hajmi: <span className="font-medium w-full rounded-full bg-gray-100 px-2 py-2 flex items-center justify-center gap-2">{product.crusts.map((item, id) => {
                return (
                  <button className='p-2 py-4 flex flex-1 items-center justify-center bg-white rounded-full'>{item}</button>
                );
              })}</span>
            </div>
          ...
          <div className="">
            {
              product.toppings.map((item, index) => {
                return (
                  <div key={index} className="gap-2 mb-2 flex items-center justify-between">
                    <div className="flex flex-1 items-center gap-2 bg-gray-100 p-2 rounded-full">
                      <LuLeaf className="text-green-600" />
